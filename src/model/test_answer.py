...
class Answer(Util.get_db().Model):
    ...
    assesment_id = Util.get_db().Column(Util.get_db().Integer, Util.get_db().ForeignKey('assesment.id'))
    ...
    def __init__(self, answer, assesment_id,is_correct, created_at, updated_at):
        self.answer = answer
